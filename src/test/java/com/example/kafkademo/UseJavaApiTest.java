...
/**
 * https://docs.spring.io/spring-kafka/docs/2.2.8.RELEASE/reference/html/#introduction
 */
public class UseJavaApiTest {

    private static final Logger logger = LoggerFactory.getLogger(UseJavaApiTest.class);
